# -*- coding: utf-8 -*-
"""
Created on Thu Jul  4 23:52:08 2019
...
args = Dotdict({
        ...
        'lpos': 2, # number of positions filled in each time step
        'M': 3, # feature planes
        'Q': 2, # 2 for binary sequence
        'alpha': 0.05, # exploration noise, i.e., \alpha in the paper
        'simBudget': 9, # MCTS simulation budget
        'eval_games': 5,
        'updateNNcycle': 3, # parameter G
        'zDNN': 2, # parameter z
        'numfilters1': 256,
        'numfilters2': 512,
        'l2_const': 1e-3,
...
#    DNN.loadParams('./bestParams/net_params.ckpt')
    ...
    meanCorr,maxCorr = evaluate_DNN(n_games = args.eval_games, tau = 0, evaluating_fn = DNN.evaluate_node)
